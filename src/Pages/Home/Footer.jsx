  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/kishan_021003"
            ...
            <li>
              <a
                href="https://www.twitter.com/Kishan1244"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/kishan-772338257/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Kishan</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
      ...
      <div className="footer--copyright">
        <p>© {new Date().getFullYear()} Kishan. All rights reserved.</p>
      </div>
    </footer>
  );
}
